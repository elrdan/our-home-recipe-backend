...
public class SpringSecurityConfig {
	...
	private RequestMatcher[] permitAllRequestMatchers() {
		List<RequestMatcher> requestMatchers = List.of(
			...
			antMatcher(GET, "/recipe/guest/*"),						// 레시피 상세 조회(guest)
			antMatcher(GET, "/recipe/comment"),						// 레시피 댓글 조회
	...
	private RequestMatcher[] userAuthRequestMatchers() {
		List<RequestMatcher> requestMatchers = List.of(
			...
			antMatcher(GET, "/recipe/member/*"),						// 레시피 상세 조회(member)
			antMatcher(POST, "/recipe/comment")						// 레시피 댓글 등록
